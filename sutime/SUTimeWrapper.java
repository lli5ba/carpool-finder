...
public class SUTimeWrapper {
	...
	private DateFormat facebookDateFormat = new SimpleDateFormat("MM/dd/yyyy HH:mm");
    private Gson gson;
    ...
    public String annotate(String input) {
	 ...
	 public String annotate(String input, String postDateFB) {
		Date date;
		try {
			date = this.facebookDateFormat.parse(postDateFB);
		} catch (ParseException e) {
			e.printStackTrace();
			date = Calendar.getInstance().getTime();
		}
        String postDate = this.dateFormat.format(date);
        Annotation annotation = new Annotation(input);
        annotation.set(CoreAnnotations.DocDateAnnotation.class, postDate);
